...
export default function ReservationPage() {
  return (
    <div className="pt-28 pb-24 min-h-screen bg-[#FAF7F2]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Page Top Header */}
        <div className="text-center mb-8">
          <span className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider bg-solly-yellow/30 text-solly-charcoal border border-solly-yellow/40 shadow-2xs mb-3">
            <Sparkles className="w-3.5 h-3.5 text-solly-charcoal" />
            Réservation en ligne
          </span>

          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-display font-black text-solly-charcoal tracking-tight">
            Composez & Réservez votre bar
          </h1>

          <p className="mt-3 text-sm sm:text-base text-solly-muted max-w-lg mx-auto">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 text-center">
          <div className="bg-white/80 backdrop-blur-xs rounded-2xl p-4 border border-solly-border/70 flex items-center justify-center gap-2.5 text-xs font-bold text-solly-charcoal shadow-2xs">
